            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 下单后，40分钟内送达,投诉电话:15228170336 </p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                ...
                <div class="col-12 col-lg-3 col-md-12 col-sm-12">
                    ...
                    <div class="hero-side-category">
                        ...
                        <div class="category-toggle-wrap">
                            <!-- Category Toggle -->
                            <button class="category-toggle" id="categorys"> <i class="fa fa-bars"></i> 商品总分类 </button>
                        </div>
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <div class="navigation-search d-none d-lg-block">
                        <form method="post" action="/fore/foreNameLike">
                            <input type="search" placeholder="Search product ..." name="pName" id="pName">
                            <button type=""><i class="icon ion-md-search" onclick="panding();"></i></button>
                        </form>
                    </div>
