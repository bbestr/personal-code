                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="address-block">
                        ...
                        <div class="address-text">
                            <ul>
                                <li>地址:四川省樂山市 </li>
                                <li>手机:15228170336 </li>
                                <li>电子邮箱:1692065699@qq.com </li>
                            </ul>
                        </div>
...
<%--                            </ul>--%>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="widget-block">
                        <h4 class="footer-widget-title mb-sm-10">信息（暂未开通）</h4>
                        <ul>
                            <li><a href="#">关于我们</a></li>
                            <li><a href="#">联系我们</a></li>
                            <li><a href="#">服务</a></li>
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="widget-block">
                        <h4 class="footer-widget-title mt-sm-20 mb-sm-10">商家指南（暂未开通）</h4>
                        <ul>
                            <li><a href="#">卖家中心</a></li>
                            <li><a href="#">物流服务</a></li>
                            <li><a href="#">交易规则</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-left mb-20 mb-md-0">
                    ...
                    <div class="footer-copyright-text">
                      <p>Copyright &copy; menglingjie <a href="#">best</a></p>
                    </div>
