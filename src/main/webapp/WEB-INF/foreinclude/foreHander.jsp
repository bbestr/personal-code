            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 下单后，40分钟内送达,投诉电话 ：15228170336 <span class="support-no">: </span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="header-top-dropdown d-flex justify-content-center justify-content-lg-end">
                        ...
                        <div class="single-dropdown">
                            ...
                            <a href="/fore/foreIndex" id="changeLanguage"><span id="languageName">首页1</span></a>
