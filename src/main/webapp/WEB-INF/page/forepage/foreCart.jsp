                            ...
                            <c:forEach items="${ois}" var="oi">
                                <tr>
                                    ...
                                    <td class="pro-thumbnail">
                                        <a href="foreDetailUI?id=${oi.pid}"><img src="${pageContext.request.contextPath}/${oi.product.imageurl}" class="img-fluid" alt="Product"></a>
                                    </td>
                                    <td class="pro-title"><a href="href=foreDetailUI?id=${oi.pid}">${oi.product.name}</a></td>
