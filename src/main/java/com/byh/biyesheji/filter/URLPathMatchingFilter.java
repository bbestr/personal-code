...
public class URLPathMatchingFilter extends PathMatchingFilter {
    ...
    protected boolean onPreHandle(ServletRequest request, ServletResponse response, Object mappedValue)
        ...
        System.out.println("URLPathmatching:"+subject.getPrincipal());
        // 如果没有登录，就跳转到登录页面
        ...
        if (!needInterceptor) {
            ...
            System.out.println("fileter："+userName);
            //查询当前用户名拥有的权限
            ...
            if (hasPermission)
                ...
                UnauthorizedException ex = new UnauthorizedException("当前用户没有访问该功能的权限");
